...
# VIAÇÃO ITAPEMIRIM:
#
cidade_16 = ['*aracaju', 'aracaju', '*aracajú', '*aracaju', 'belo horizonte - "itapemirim"', 'campina grande', '*curitiba', '*feira de santana', '*guarapari', '*guaraparí', '*ipatinga', '*nanuque', 'rio de janeiro - itapemirim' , 'salvador', 'são paulo - itapemirim', 'sao paulo - itapemirim', 'vitória da conquista - itapemirim', 'vitoria da conquista - ']
cidade_16 = ['*aracaju', 'aracaju', '*aracajú', '*aracaju', 'belo horizonte - "itapemirim"', 'campina grande', '*curitiba', '*feira de santana', '*guarapari', '*guaraparí', '*ipatinga', '*nanuque', 'rio de janeiro - itapemirim' , 'salvador', 'são paulo - itapemirim', 'sao paulo - itapemirim', 'vitória da conquista - itapemirim', 'vitoria da conquista - itapemirim']
#
# VIAÇÃO brasil bus:
#
...
# VIAÇÃO RODE ROTAS:
#
cidade_18 = ['uruaçú - rode rotas', 'porangatú - rode rotas', 'gurupí - rota rotas', 'paraíso do tocantins', 'miranorte', 'guaraí', 'araguaína', 'estreito', 'porto franco', 'imperatriz - rode rotas', 'açailândia', 'itinga do maranhão', 'dom eliseu', 'ulianópolis', 'ulianopolis', 'paragominas', 'ipixuna']
#
#
